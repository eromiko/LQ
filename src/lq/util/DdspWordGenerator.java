...
public class DdspWordGenerator {
    ...
    static {
        ...
        configuration.setClassForTemplateLoading(DdspWordGenerator.class, "/lq/template");
        allTemplates = new HashMap<>(); // Java 7 钻石语法
        try {
            allTemplates.put("员工调动审批表",configuration.getTemplate("ddsp.xml"));
        } catch (IOException e) {
            e.printStackTrace();
