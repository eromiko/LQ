...
public class SDxjsqbWordGenerator {
    ...
    static {
        ...
        configuration.setClassForTemplateLoading(SDxjsqbWordGenerator.class, "/lq/template");
        allTemplates = new HashMap<>(); // Java 7 钻石语法
        try {
            allTemplates.put("蜀道投资集团公司总部员工请休假申请表",configuration.getTemplate("sdxjsqb.xml"));
        } catch (IOException e) {
            e.printStackTrace();
